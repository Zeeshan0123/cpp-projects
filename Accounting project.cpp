...
public:
	...
	void display_logo()
	{
		...
		in << setw(50) << date << endl;
			...
			in << endl;
			in << setw(10) << "DATE|" << setw(25) << "DISCRIPTION" << setw(50) << "|DEBIT" << setw(20) << "|CREDIT" << endl;
...
//	_strtime_s(time);
	...
	for ( i = 1; i < 50; i++)
	{
		cout << "\n\n\n\n              IF YOU WANT TO FINISH ENTER 1 ELSE 0:   ";
		cin >> number;
		system("cls");
		if (number > 0)
			break;
	...
	cout <<" \n\n\n\n              IF YOU WANT TO SEE YOUR LEDGERS ENTER 1 ELSE 0:";
	cin >> number;
	if (number == 0)
		exit;
